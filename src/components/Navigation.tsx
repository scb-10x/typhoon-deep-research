...
export default function Navigation() {
  ...
  return (
    <nav className="w-full bg-white dark:bg-gray-900 py-4 border-b border-gray-200 dark:border-gray-800 shadow-md backdrop-blur-lg bg-opacity-90 dark:bg-opacity-90 fixed top-0 left-0 right-0 z-50">
